      ...
      <nav
        ...
        <PopoverGroup className="hidden lg:flex lg:gap-x-12">
          ...
          <Popover className="relative">
            <PopoverButton className="flex items-center gap-x-1 text-sm font-medium leading-6 text-gray-900">
              Classes
              <ChevronDownIcon
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end gap-x-3">
          <Search className="h-6 w-6 text-gray-900 hover:scale-125 cursor-pointer hover:transition-transform" />
          <ShoppingCart className="h-6 w-6 text-gray-900 hover:scale-125 cursor-pointer hover:transition-transform" />
          <User className="h-6 w-6 text-gray-900 hover:scale-125 cursor-pointer hover:transition-transform" />
        </div>
      </nav>
      <Dialog
        className="lg:hidden"
            ...
            <div className="-my-6 divide-y divide-gray-500/10">
              <div className="space-y-2 py-6">
                <Disclosure as="div" className="-mx-3">
                  {({ open }) => (
                    <>
                      <DisclosureButton className="flex w-full items-center justify-between rounded-lg py-2 pl-3 pr-3.5 text-base font-medium leading-7 text-gray-900 hover:bg-gray-50">
                        Classes
                        <ChevronDownIcon
